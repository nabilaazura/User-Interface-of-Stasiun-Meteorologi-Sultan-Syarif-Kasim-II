...
<html lang="en">
    <head>
        ...
        <title>Register | SiPelDatIn</title>
        <!-- Favicon-->
                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="<?php echo base_url('index.php/register/proses'); ?>">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="nama" name="nama" type="text" placeholder="Masukkan Nama Anda" />
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="<?php echo base_url('index.php/login'); ?>">Sudah Punya Akun? Yuk Login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; SiPelDatIn - Stasiun Meteorologi SSK II Pekanbaru</div>
                            <div>
